<nav class="blue-grey darken-2" role="navigation">
	<div class="nav-wrapper container">
		...
		<ul id="slide-out" class="side-nav">
			...
			<li><a href="<?php echo BASE_URL.'login/logout?url='.getCurrentUrl();?>"><i class="material-icons left">exit_to_app</i> Déconnexion</a></li>
			<?php }else{?>
			<li><a href="<?php echo BASE_URL.'login?url='.getCurrentUrl();?>"><i class="material-icons left">lock_open</i>Connexion</a></li>
		...
		<ul class="right hide-on-med-and-down">
			<li><a href="<?php echo BASE_URL.'login?url='.getCurrentUrl();?>">Connexion</a></li>
		...
		<ul id="logguedIn" class="dropdown-content">
			<li><a href="<?php echo BASE_URL_ADMIN;?>"><i class="material-icons left">account_circle</i> Mon compte</a></li>
			<?php if(in_array($_SESSION['role'], ['Membre', 'Administrateur'])){?><li><a href="<?php echo BASE_URL;?>question/index?mesQuestions"><i class="material-icons left">feedback</i> Mes questions</a></li><?php }?>
			<li class="divider"></li>
			<li><a href="<?php echo BASE_URL.'login/logout?url='.getCurrentUrl();?>"><i class="material-icons left">exit_to_app</i> Déconnexion</a></li>
		</ul>
		<ul class="right hide-on-med-and-down">
