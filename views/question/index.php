...
<div class="row">
	...
	<div class="col s12">
		<ul class="tabs">
			<li class="tab col s6"><a class="ACCENT_COLOR <?php echo (!isset($_GET['mesQuestions']))?'active':'';?>" href="#allQuestions">Toutes les questions</a></li>
			<li class="tab col s6"><a class="ACCENT_COLOR <?php echo (isset($_GET['mesQuestions']))?'active':'';?>" href="#myQuestions">Mes questions</a></li>
		</ul>
	</div>
	<?php }?>
