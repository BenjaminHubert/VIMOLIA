<form method="post" action=""  enctype="multipart/form-data">
	<div class="row">
		...
		<div class="input-field col s12 m6 l4">
			<input type="text" id="first_name" name="first_name" value="<?php echo $_SESSION['first_name'];?>" readonly> <label for="first_name">Prénom*</label>
		</div>
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
		...
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
			<input type="text" id="city" name="city" value="<?php echo (isset($_POST['city']))?$_POST['city']:$_SESSION['city'];?>" required> <label for="city">Ville*</label>
		</div>
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
			<textarea id="symptoms" placeholder="Décrivez vos symptômes ici" name="symptoms" class="materialize-textarea" required><?php echo (isset($_POST['symptoms']))?$_POST['symptoms']:'';?></textarea>
			<label for="symptoms">Symptômes*</label>
		</div>
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
			<textarea id="particularPains" placeholder="Décrivez vos douleurs ici" name="particularPains" class="materialize-textarea"><?php echo (isset($_POST['particularPains']))?$_POST['particularPains']:'';?></textarea>
			<label for="particularPains">Douleurs particulières ?</label>
		</div>
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
			<textarea id="antecedents" placeholder="Décrivez vos éventuels antécédents ici" name="antecedents" class="materialize-textarea"><?php echo (isset($_POST['antecedents']))?$_POST['antecedents']:'';?></textarea>
			<label for="antecedents">Antécédents</label>
		</div>
		<div class="col s12 m6 offset-m3 l8 offset-l3"></div>
		<div class="input-field col s12 m6 l4">
			<textarea id="usefulInfo" placeholder="Indiquer d'autres informations pouvant aider à la compréhension de votre cas ici" name="usefulInfo" class="materialize-textarea"><?php echo (isset($_POST['usefulInfo']))?$_POST['usefulInfo']:'';?></textarea>
