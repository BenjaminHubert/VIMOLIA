<form action="" method="post">
	<div class="row">
		...
		<div class="input-field col s12 m6">
			<textarea id="description" name="description" class="materialize-textarea" length="250" required></textarea>
        	<label for="description">Description</label>
		</div>
		<div class="input-field col s6 m3">
			<input id="amount" name="amount" type="number" step="0.01" min="0.01" class="validate" style="text-align:right" required>
		...
		<div class="input-field col s12 m6">
			<input id="duration_days" name="duration_days" type="number" step="1" min="1" class="validate" required>
