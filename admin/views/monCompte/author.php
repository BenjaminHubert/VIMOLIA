<form action="" enctype="multipart/form-data" method="post">
		<div class="row">
            ...
            <div class="input-field col s12">
                ...
                <input id="address" name="address" type="text" class="validate" value="<?php echo htmlentities($_SESSION['address']);?>">
                <label for="address">Adresse </label>
            </div>
            <div class="input-field col s3">
                <i class="material-icons prefix">place</i>
                <input id="postal_code" name="postal_code" type="text" class="validate" pattern="[0-9]{5}" value="<?php echo htmlentities($_SESSION['postal_code']);?>">
                <label for="postal_code" data-error="Veuillez saisir un code à 5 chiffres">Code postal </label>
            </div>
            <div class="input-field col s9">
                <i class="material-icons prefix">place</i>
                <input id="city" name="city" type="text" class="validate" value="<?php echo htmlentities($_SESSION['city']);?>">
            ...
            <div class="input-field col s6">
                <i class="material-icons prefix">contact_phone</i>
                <input id="mobile" name="mobile" type="text" class="validate" value="<?php echo htmlentities($_SESSION['mobile']);?>" pattern="[0-9]{10}">
